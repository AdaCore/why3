...
\item[\texttt{realize}] generates interactive proof skeletons for
  \why input files.
\item[\texttt{replayer}] replays the proofs stored in a session,
...
\section{The \texttt{replayer} Command}
\label{sec:why3replayer}

The \texttt{replayer} command is meant to execute the proofs
...
all the examples.
\index{replayer@\texttt{replayer}}

The tool is invoked in a terminal or a script using
\begin{flushleft}\ttfamily
  why3 replayer \textsl{[options] <project directory>}
\end{flushleft}
