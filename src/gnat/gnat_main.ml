...
module Objectives : sig
   ...
   (* Goals can be not interesting, when they are trivial or autogenerated *)
...
let rec is_trivial_autogen fml =
   (* Check wether the formula was autogenerated or is trivial. In both cases,
      we should not consider such formulas. *)
...
let register_goal goal =
    ...
    * trivial or autogenerated, do not register *)
