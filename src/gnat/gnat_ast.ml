...
and why_node_info = {node: node_id; domain: domain; link: why_node_set; checked: bool}
...
module From_json = struct
  ...
  let rec why_node_from_json : 'a why_node from_json = function
    | `List [`String "W_TYPE"; node; domain; link; checked; type_kind; name; is_mutable; relaxed_init] ->
      let info = {
      ...
      {info; desc}
    | `List [`String "W_NAME"; node; domain; link; checked; symb; namespace; module_; infix] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_EFFECTS"; node; domain; link; checked; reads; writes; raises] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_BINDER"; node; domain; link; checked; name; arg_type] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_TRANSPARENT_TYPE_DEFINITION"; node; domain; link; checked; type_definition] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_RECORD_BINDER"; node; domain; link; checked; name; arg_type; labels; is_mutable] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_RECORD_DEFINITION"; node; domain; link; checked; fields] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_RANGE_TYPE_DEFINITION"; node; domain; link; checked; first; last] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_TRIGGERS"; node; domain; link; checked; triggers] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_TRIGGER"; node; domain; link; checked; terms] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_POSTCONDITION"; node; domain; link; checked; pred; handlers] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_EXN_CONDITION"; node; domain; link; checked; exn_case; pred] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_HANDLER"; node; domain; link; checked; name; arg; def] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_FIELD_ASSOCIATION"; node; domain; link; checked; field; value] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_UNIVERSAL_QUANTIF"; node; domain; link; checked; variables; labels; var_type; triggers; pred] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_EXISTENTIAL_QUANTIF"; node; domain; link; checked; variables; labels; var_type; pred] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_NOT"; node; domain; link; checked; right] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_CONNECTION"; node; domain; link; checked; left; op; right; more_right] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_LABEL"; node; domain; link; checked; labels; def; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_LOC_LABEL"; node; domain; link; checked; sloc; def; marker] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_IDENTIFIER"; node; domain; link; checked; name; typ; labels] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_TAGGED"; node; domain; link; checked; tag; def; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_CALL"; node; domain; link; checked; name; args; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_LITERAL"; node; domain; link; checked; value; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_BINDING"; node; domain; link; checked; name; def; context; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_ELSIF"; node; domain; link; checked; condition; then_part; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_EPSILON"; node; domain; link; checked; name; typ; pred] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_CONDITIONAL"; node; domain; link; checked; condition; then_part; elsif_parts; else_part; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_INTEGER_CONSTANT"; node; domain; link; checked; value] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_RANGE_CONSTANT"; node; domain; link; checked; value; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_MODULAR_CONSTANT"; node; domain; link; checked; value; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_FIXED_CONSTANT"; node; domain; link; checked; value; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_REAL_CONSTANT"; node; domain; link; checked; value] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_FLOAT_CONSTANT"; node; domain; link; checked; value; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_COMMENT"; node; domain; link; checked; comment] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_DEREF"; node; domain; link; checked; right; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_RECORD_ACCESS"; node; domain; link; checked; name; field; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_RECORD_UPDATE"; node; domain; link; checked; name; updates; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_RECORD_AGGREGATE"; node; domain; link; checked; associations; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_ANY_EXPR"; node; domain; link; checked; effects; pre; post; return_type; labels] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_ASSIGNMENT"; node; domain; link; checked; name; value; typ; labels] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_BINDING_REF"; node; domain; link; checked; name; def; context; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_WHILE_LOOP"; node; domain; link; checked; condition; invariants; loop_content] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_STATEMENT_SEQUENCE"; node; domain; link; checked; statements] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_ABSTRACT_EXPR"; node; domain; link; checked; expr; post; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_ASSERT"; node; domain; link; checked; pred; assert_kind] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_RAISE"; node; domain; link; checked; name; exn_type; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_TRY_BLOCK"; node; domain; link; checked; prog; handler; typ] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_FUNCTION_DECL"; node; domain; link; checked; name; binders; effects; pre; post; return_type; def; labels; location] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_AXIOM"; node; domain; link; checked; name; def] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_GOAL"; node; domain; link; checked; name; def] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_TYPE_DECL"; node; domain; link; checked; args; name; labels; definition] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_GLOBAL_REF_DECLARATION"; node; domain; link; checked; name; ref_type; labels; location] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_NAMESPACE_DECLARATION"; node; domain; link; checked; declarations; name] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_EXCEPTION_DECLARATION"; node; domain; link; checked; name; arg] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_INCLUDE_DECLARATION"; node; domain; link; checked; module_; kind; use_kind] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_META_DECLARATION"; node; domain; link; checked; name; parameter] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_CLONE_DECLARATION"; node; domain; link; checked; origin; as_name; clone_kind; substitutions; theory_kind] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_CLONE_SUBSTITUTION"; node; domain; link; checked; kind; orig_name; image] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_THEORY_DECLARATION"; node; domain; link; checked; declarations; name; kind; includes; comment] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_CUSTOM_SUBSTITUTION"; node; domain; link; checked; from; to_] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_CUSTOM_DECLARATION"; node; domain; link; checked; file_name] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
      ...
      {info; desc}
    | `List [`String "W_MODULE"; node; domain; link; checked; file; name] ->
      let info = {
        node = node_id_from_json node;
        domain = domain_from_json domain;
        link = why_node_set_from_json link;
