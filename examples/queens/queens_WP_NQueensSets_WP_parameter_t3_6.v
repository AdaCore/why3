...
Theorem WP_parameter_t3 : forall (a:(set Z)) (b:(set Z)) (c:(set Z)),
  ...
  forall (e1:(set Z)), (e1 = (remove d e)) -> forall (i:Z) (j:Z), (mem i
  (diff (diff (diff a b) c) e1)) -> ((mem j e1) -> (i < j)%Z)))).
intros a b c. generalize (diff (diff a b) c) as abc.
intros abc s sol k col (h1,(h2,(h3,(h4,(h5,(h6,h7)))))) h8 f e s1
        sol1 k1 col1 ((h9,h10),(h11,(h12,(h13,(h14,(h15,(h16,(h17,h18))))))))
        h19 d col2 h20 k2 h21 o (h22,(h23,(h24,(h25,(h26,(h27,h28)))))) s2
        sol2 k3 col3 (h29,(h30,(h31,(h32,(h33,h34))))) f1 h35 k4 h36 e1 h37 i
        j h38 h39.
assert (not (mem i e1)).
