...
(* Why3 goal *)
Theorem WP_parameter_build : forall (s:(list Z)), (forall (t:tree) (s':(list
  Z)), ~ ((infix_plpl (depths 0%Z t) s') = s)) -> forall (t:tree),
  ~ ((depths 0%Z t) = s).
(* YOU MAY EDIT THE PROOF BELOW *)
intuition.
replace (depths 0 t) with (infix_plpl (depths 0 t) Nil) in H0.
apply (H _ _ H0).
apply Append_l_nil.
Qed.
