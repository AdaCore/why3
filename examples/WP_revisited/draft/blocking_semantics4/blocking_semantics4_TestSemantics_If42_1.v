...
Theorem If42 : forall (sigma1:(map mident value)) (sigma2:(map mident value))
  (pi1:(list (ident* value)%type)) (pi2:(list (ident* value)%type)) (e:expr),
  (one_step (const (Vint 0%Z):(map mident value)) (Cons (x, (Vint 42%Z))
  (Nil :(list (ident* value)%type))) (Eif (Ebin (Ederef y) Ole
  (Evalue (Vint 10%Z))) (Eassign y (Evalue (Vint 13%Z))) (Eassign y
  (Evalue (Vint 42%Z)))) sigma1 pi1 e) -> ((one_step sigma1 pi1 e sigma2 pi2
  (Evalue Vvoid)) -> ((get sigma2 y) = (Vint 13%Z))).
intros sigma1 sigma2 pi1 pi2 e h1 h2.
