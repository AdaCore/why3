...
Theorem many_steps_seq :
  forall (sigma1:mident -> value) (sigma3:mident -> value)
    (pi1:(list (ident* value)%type)) (pi3:(list (ident* value)%type))
    (s1:stmt) (s2:stmt) (n:Z),
  (many_steps sigma1 pi1 (Sseq s1 s2) sigma3 pi3 Sskip n) ->
  exists sigma2:mident -> value, exists pi2:(list (ident* value)%type),
  exists n1:Z, exists n2:Z,
