...
Theorem WP_parameter_compile_aexpr : forall (a:aexpr),
  ...
  | (Aadd a1 a2) => forall (o:(list instr)) (o1:(func Z (func machine_state
      ...
      ((infix_at (infix_at (infix_at iadd_post p) ms) ms') = true)) /\
      ((total_correctness o3) /\ ((list.Length.length o) = 1%Z)))) ->
      ((total_correctness o3) -> forall (o4:(list instr)) (o5:(func Z (func
      (func machine_state bool) (func machine_state bool)))), let o6 :=
      (mk_wp o4 o5) in (((transformer o6) /\ ((o4 = o) /\
      (o5 = (towp_wp o3)))) -> forall (o7:(list instr)) (o8:(func Z (func
      machine_state bool))) (o9:(func Z (func machine_state (func
      machine_state bool)))), let o10 := (mk_codespec o7 o8 o9) in
...
repeat match goal with [ H : transformer _ |- _ ] => clear H end.
repeat match goal with [ H : total_correctness _ |- _ ] => clear H end.
repeat match goal with [ H : ?a = _ |- _ ] => rewrite H in *;clear a H
  | [ H := _ |- _ ] => unfold H in *;clear H end.
simpl in *.
repeat (rewrite seq_wp_def in *;simpl).
repeat (rewrite towp_wp_def in *;simpl;split;intros);
repeat rewrite aexpr_post_def in *;
repeat rewrite aexpr_pre_def in *;ae.
Qed.
