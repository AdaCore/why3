...
Theorem VC_div3by2_inv : forall (uh:uint32) (um:uint32) (ul:uint32)
  ...
  ((0%Z < bbd)%Z -> ((~ ((to_int3 uh) <= ((to_int3 dh) - 1%Z)%Z)%Z) ->
  (((to_int3 uh) = (to_int3 dh)) ->
  (((to_int3 um) <= ((to_int3 dl) - 1%Z)%Z)%Z ->
  (((((4294967295%Z + 1%Z)%Z * cr)%Z = (((((k * (to_int3 dh))%Z + ((((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z - d)%Z * (to_int3 um))%Z)%Z + ((4294967295%Z + 1%Z)%Z * (to_int3 ul))%Z)%Z + (d * q0)%Z)%Z - ((4294967295%Z + 1%Z)%Z * d)%Z)%Z) /\
  ...
  ((((((d * (to_int3 dh))%Z + ((((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z - d)%Z * ((to_int3 dl) - 1%Z)%Z)%Z)%Z + ((4294967295%Z + 1%Z)%Z * (to_int3 ul))%Z)%Z + (d * q0)%Z)%Z - ((4294967295%Z + 1%Z)%Z * d)%Z)%Z < (((((d * (to_int3 dh))%Z + ((((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z - d)%Z * ((to_int3 dl) - 1%Z)%Z)%Z)%Z + ((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z)%Z + (d * q0)%Z)%Z - ((4294967295%Z + 1%Z)%Z * d)%Z)%Z)%Z))) ->
  ((((bbd * bbd)%Z + ((d * q0)%Z * (4294967295%Z + 1%Z)%Z)%Z)%Z - (((4294967295%Z + 1%Z)%Z - (to_int3 dl))%Z * ((((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z - (d * (1%Z + (4294967295%Z + 1%Z)%Z)%Z)%Z)%Z)%Z)%Z <= (((bbd * m)%Z + ((d * q0)%Z * (4294967295%Z + 1%Z)%Z)%Z)%Z - (((4294967295%Z + 1%Z)%Z - (to_int3 dl))%Z * ((((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z - (d * (1%Z + (4294967295%Z + 1%Z)%Z)%Z)%Z)%Z)%Z)%Z)%Z)))))))))))))))))))))).
...
h53 bbd h54 h55 h56 h57 (h58,(h59,(h60,h61))).
