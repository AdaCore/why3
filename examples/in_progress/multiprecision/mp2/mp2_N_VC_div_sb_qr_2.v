...
Theorem VC_div_sb_qr : forall (q:(ptr uint64)) (x:(ptr uint64)) (y:(ptr
  ...
  ((o36 = true) -> (((to_int2 cy2) = 1%Z) -> ((0%Z < (to_int2 ql))%Z ->
  let o37 := (((offset y) + (to_int sy))%Z - 1%Z)%Z in let o38 :=
  (offset y) in let o39 := (pelts y) in (((value_sub o39 o38
  (o37 + 1%Z)%Z) = ((value_sub o39 o38 o37) + ((to_int2 (o39
  o37)) * (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o37 - o38)%Z))%Z)%Z) -> let o40 :=
  (((offset y) + (to_int sy))%Z - 2%Z)%Z in let o41 := (offset y) in
  let o42 := (pelts y) in (((value_sub o42 o41
  (o40 + 1%Z)%Z) = ((value_sub o42 o41 o40) + ((to_int2 (o42
  o40)) * (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o40 - o41)%Z))%Z)%Z) -> ((vy = (((value_sub_shift y
  ((to_int sy) - 2%Z)%Z) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  ((to_int sy) - 2%Z)%Z) * (to_int2 dl))%Z)%Z + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  ((to_int sy) - 1%Z)%Z) * (to_int2 dh))%Z)%Z) ->
  ((((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (to_int sy)) - vy)%Z <= ((value_sub_shift xd3
  ((to_int sy) - 1%Z)%Z) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  ((to_int sy) - 1%Z)%Z) * (to_int2 x13))%Z)%Z)%Z -> let o43 :=
  ...
  (((x6 = (mk_ptr (data x6) (offset x5))) /\
  ((length (contents (data x6))) = (length (contents (data x5))))) ->
  forall (c:uint64), ((((value_sub_shift xd4
  (to_int o46)) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (to_int o46)) * (to_int2 c))%Z)%Z = ((value_sub_shift xd3
  (to_int o46)) + ((value_sub_shift y
  (to_int o46)) * (to_int2 uone))%Z)%Z) /\ forall (j:Z),
  ((j < (offset xd1))%Z \/ (((offset xd1) + (to_int o46))%Z <= j)%Z) ->
  (((pelts xd4) j) = ((pelts xd3) j))) -> (((value_sub_shift x6
  (to_int i1)) = (value_sub_shift x5 (to_int i1))) -> forall (x14:uint64),
  (((value_sub_shift xd4
  ((to_int sy) - 1%Z)%Z) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  ((to_int sy) - 1%Z)%Z) * (to_int2 x14))%Z)%Z = ((((value_sub_shift xd3
  ((to_int sy) - 1%Z)%Z) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  ((to_int sy) - 1%Z)%Z) * (to_int2 x13))%Z)%Z + vy)%Z - (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (to_int sy)))%Z) -> forall (o47:uint64),
  ((to_int2 o47) = ((to_int2 ql) - (to_int2 uone))%Z) -> forall (ql1:uint64),
  (ql1 = o47) -> ((((value_sub_shift xd4
  ((to_int sy) - 1%Z)%Z) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  ((to_int sy) - 1%Z)%Z) * (to_int2 x14))%Z)%Z = (((value_sub_shift xd1
  (to_int sy)) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (to_int sy)) * (to_int2 x11))%Z)%Z - ((to_int2 ql1) * vy)%Z)%Z) ->
  forall (o48:(ptr uint64)),
  (((offset o48) = ((offset qp) + (to_int minus_one))%Z) /\
  ((data o48) = (data qp))) -> forall (qp1:(ptr uint64)), (qp1 = o48) ->
  let o49 :=
  ((((offset qp1) + (to_int sx))%Z - (to_int sy))%Z - (to_int i1))%Z in
  let o50 := ((offset qp1) + 1%Z)%Z in let o51 := (pelts q1) in
  (((value_sub o51 o50 o49) = (value_sub (map.Map.set o51 (offset qp1) ql1)
  o50 o49)) -> forall (qp2:(ptr uint64)) (q2:(ptr uint64)),
  ...
  (offset qp1) ql1)) -> let o52 :=
  ((((offset qp2) + (to_int sx))%Z - (to_int sy))%Z - (to_int i1))%Z in
  let o53 := (offset qp2) in let o54 := (pelts q2) in (((value_sub o54 o53
  o52) = ((to_int2 (o54
  o53)) + ((18446744073709551615%Z + 1%Z)%Z * (value_sub o54 (o53 + 1%Z)%Z
  o52))%Z)%Z) -> let o55 :=
  ((((offset x6) + (to_int sy))%Z + (to_int i1))%Z - 1%Z)%Z in let o56 :=
  (offset x6) in let o57 := (pelts x6) in (((value_sub o57 o56
  (o55 + 1%Z)%Z) = ((value_sub o57 o56 o55) + ((to_int2 (o57
  o55)) * (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o55 - o56)%Z))%Z)%Z) -> let o58 := ((offset x6) + s)%Z in let o59 :=
  (offset xd1) in let o60 := (offset x6) in let o61 := (pelts x6) in
  (((value_sub o61 o60 o58) = ((value_sub o61 o60 o59) + ((value_sub o61 o59
  o58) * (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o59 - o60)%Z))%Z)%Z) -> (((value_sub_shift qp2
  (((to_int sx) - (to_int sy))%Z - (to_int i1))%Z) = ((to_int2 ql1) + ((18446744073709551615%Z + 1%Z)%Z * (value_sub (pelts q2)
  ((offset qp2) + 1%Z)%Z
  ...
  (((to_int sx) - (to_int sy))%Z - (to_int i1))%Z) = ((to_int2 ql1) + ((18446744073709551615%Z + 1%Z)%Z * (value_sub_shift qp
  (((to_int sx) - (to_int sy))%Z - k)%Z))%Z)%Z) -> (((value_sub_shift x6
  s) = ((value_sub_shift x6
  (to_int i1)) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (to_int i1)) * (value_sub_shift xd4 ((to_int sy) - 1%Z)%Z))%Z)%Z) ->
  let m := ((to_int sy) - 1%Z)%Z in let x7 :=
  (18446744073709551615%Z + 1%Z)%Z in (((int.Power.power x7
  s) = (int.Power.power x7 ((to_int i1) + m)%Z)) ->
  (((0%Z <= (to_int i1))%Z /\ ((0%Z <= m)%Z /\ forall (x8:Z) (n:Z) (m1:Z),
  (0%Z <= n)%Z -> ((0%Z <= m1)%Z -> ((int.Power.power x8
