...
Theorem VC_div3by2_inv : forall (uh:uint64) (um:uint64) (ul:uint64)
  ...
  let bbd :=
  (((18446744073709551615%Z + 1%Z)%Z * (18446744073709551615%Z + 1%Z)%Z)%Z - d)%Z in
  ((0%Z < bbd)%Z -> (((to_int2 uh) <= ((to_int2 dh) - 1%Z)%Z)%Z -> let dm :=
  ((to_int2 dh) - 1%Z)%Z in (((to_int2 uh) <= dm)%Z ->
  (((k * (to_int2 uh))%Z <= (k * dm)%Z)%Z -> (((k * dm)%Z <= (d * dm)%Z)%Z ->
  (((k * (to_int2 uh))%Z <= (d * dm)%Z)%Z ->
  ((bbd * (to_int2 um))%Z <= (bbd * ((18446744073709551615%Z + 1%Z)%Z - 1%Z)%Z)%Z)%Z))))))))))))))))))))))).
...
bbd h54 h55 dm h56 h57 h58 h59.
