...
(* Why3 goal *)
Theorem VC_div3by2_inv : forall (uh:uint64) (um:uint64) (dh:uint64)
  (dl:uint64) (v:uint64),
  ...
  ((((to_int2 um) + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 uh))%Z)%Z < d)%Z ->
  ((((18446744073709551615%Z + 1%Z)%Z * (to_int2 uh))%Z < d)%Z ->
  ((((18446744073709551615%Z + 1%Z)%Z * d)%Z + (((to_int2 v) * (18446744073709551615%Z + 1%Z)%Z)%Z * (to_int2 uh))%Z)%Z <= (((18446744073709551615%Z + 1%Z)%Z * d)%Z + ((to_int2 v) * d)%Z)%Z)%Z))).
intros uh um dh dl v (h1,(h2,h3)) d zero h4 one h5 o o1 h6 o2 o3 (h7,(h8,h9))
o4 o5 (h10,(h11,h12)) h13 h14 h15.
