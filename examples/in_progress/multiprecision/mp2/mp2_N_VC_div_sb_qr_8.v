...
Theorem VC_div_sb_qr : forall (q:(ptr uint64)) (x:(ptr uint64)) (y:(ptr
  ...
  (o14 - o15)%Z))%Z)%Z) -> forall (o17:int32),
  ((to_int o17) = ((to_int sy) - (to_int two))%Z) -> forall (xp3:(ptr
  ...
  (to_int o17)) - ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (to_int o17)) * (to_int2 cy))%Z)%Z = ((value_sub_shift xd1
  (to_int o17)) - ((value_sub_shift y (to_int o17)) * (to_int2 ql))%Z)%Z) /\
  forall (j:Z), ((j < (offset xd1))%Z \/
  (((offset xd1) + (to_int o17))%Z <= j)%Z) -> (((pelts xd2)
  j) = ((pelts xd1) j))) -> (((value_sub_shift x4
  (to_int i1)) = (value_sub_shift x3 (to_int i1))) ->
  ((((to_int2 x0) < (to_int2 cy))%Z -> forall (o18:uint64),
  ((to_int2 o18) = (int.EuclideanDivision.mod1 ((to_int2 x0) - (to_int2 cy))%Z
  (18446744073709551615%Z + 1%Z)%Z)) -> forall (x01:uint64), (x01 = o18) ->
  ((((to_int2 x12) < (to_int2 uone))%Z -> forall (o19:uint64),
  ((to_int2 o19) = (int.EuclideanDivision.mod1 ((to_int2 x12) - (to_int2 uone))%Z
  (18446744073709551615%Z + 1%Z)%Z)) -> forall (x13:uint64), (x13 = o19) ->
  (((0%Z <= (to_int2 uone))%Z /\ ((to_int2 uone) <= 1%Z)%Z) -> let o20 :=
  (((offset xd1) + (to_int sy))%Z - 1%Z)%Z in let o21 := (offset xd1) in
  let o22 := (offset xp3) in let o23 := (pelts x4) in
  (((value_sub (map.Map.set o23 o22 x01) o21 o20) = ((value_sub o23 o21
  o20) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o22 - o21)%Z) * ((to_int2 x01) - (to_int2 (o23 o22)))%Z)%Z)%Z) ->
  let o24 := ((offset x4) + (to_int i1))%Z in let o25 := (offset x4) in
  let o26 := (pelts x4) in (((value_sub o26 o25
  o24) = (value_sub (map.Map.set o26 (offset xp3) x01) o25 o24)) ->
  ...
  (to_int i1)) = (value_sub_shift x3 (to_int i1))) -> let o27 :=
  (((offset xd1) + (to_int sy))%Z - 1%Z)%Z in let o28 := (offset xd1) in
  let o29 := (pelts x5) in (((value_sub o29 o28
  (o27 + 1%Z)%Z) = ((value_sub o29 o28 o27) + ((to_int2 (o29
  o27)) * (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o27 - o28)%Z))%Z)%Z) -> (((((value_sub_shift xd3
  ...
  forall (o30:bool), (((~ (uone = limb_zero)) -> (o30 = true)) /\
  ((o30 = true) -> ~ ((to_int2 uone) = (to_int2 limb_zero)))) ->
  ((~ (o30 = true)) -> forall (o31:(ptr uint64)),
  (((offset o31) = ((offset qp) + (to_int minus_one))%Z) /\
  ((data o31) = (data qp))) -> forall (qp1:(ptr uint64)), (qp1 = o31) ->
  let o32 :=
  ((((offset qp1) + (to_int sx))%Z - (to_int sy))%Z - (to_int i1))%Z in
  let o33 := ((offset qp1) + 1%Z)%Z in let o34 := (pelts q1) in
  (((value_sub o34 o33 o32) = (value_sub (map.Map.set o34 (offset qp1) ql)
  o33 o32)) -> forall (qp2:(ptr uint64)) (q2:(ptr uint64)),
  ...
  (offset qp1) ql)) -> let o35 :=
  ((((offset qp2) + (to_int sx))%Z - (to_int sy))%Z - (to_int i1))%Z in
  let o36 := (offset qp2) in let o37 := (pelts q2) in (((value_sub o37 o36
  o35) = ((to_int2 (o37
  o36)) + ((18446744073709551615%Z + 1%Z)%Z * (value_sub o37 (o36 + 1%Z)%Z
  o35))%Z)%Z) -> let o38 :=
  ((((offset x5) + (to_int sy))%Z + (to_int i1))%Z - 1%Z)%Z in let o39 :=
  (offset x5) in let o40 := (pelts x5) in (((value_sub o40 o39
  (o38 + 1%Z)%Z) = ((value_sub o40 o39 o38) + ((to_int2 (o40
  o38)) * (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o38 - o39)%Z))%Z)%Z) -> let o41 := ((offset x5) + s)%Z in let o42 :=
  (offset xd1) in let o43 := (offset x5) in let o44 := (pelts x5) in
  (((value_sub o44 o43 o41) = ((value_sub o44 o43 o42) + ((value_sub o44 o42
  o41) * (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o42 - o43)%Z))%Z)%Z) -> (((value_sub_shift qp2
  ...
  let o20 := (((offset xd1) + (to_int sy))%Z - 1%Z)%Z in let o21 :=
  (offset xd1) in let o22 := (offset xp3) in let o23 := (pelts x4) in
  (((value_sub (map.Map.set o23 o22 x01) o21 o20) = ((value_sub o23 o21
  o20) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o22 - o21)%Z) * ((to_int2 x01) - (to_int2 (o23 o22)))%Z)%Z)%Z) ->
  let o24 := ((offset x4) + (to_int i1))%Z in let o25 := (offset x4) in
  ...
  (to_int sy)) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (to_int sy)) * (to_int2 x11))%Z)%Z - ((to_int2 ql) * vy)%Z)%Z) ->
  forall (o30:bool), (((~ (limb_zero = limb_zero)) -> (o30 = true)) /\
  ((o30 = true) -> ~ ((to_int2 limb_zero) = (to_int2 limb_zero)))) ->
  ((~ (o30 = true)) -> forall (o31:(ptr uint64)),
  (((offset o31) = ((offset qp) + (to_int minus_one))%Z) /\
  ((data o31) = (data qp))) -> forall (qp1:(ptr uint64)), (qp1 = o31) ->
  let o32 :=
  ...
  ((to_int2 o18) = (int.EuclideanDivision.mod1 ((to_int2 x0) - (to_int2 cy))%Z
  (18446744073709551615%Z + 1%Z)%Z)) -> forall (x01:uint64), (x01 = o18) ->
  ((((to_int2 x12) < (to_int2 limb_zero))%Z -> forall (o19:uint64),
  ((to_int2 o19) = (int.EuclideanDivision.mod1 ((to_int2 x12) - (to_int2 limb_zero))%Z
  (18446744073709551615%Z + 1%Z)%Z)) -> forall (x13:uint64), (x13 = o19) ->
  (((0%Z <= (to_int2 uone))%Z /\ ((to_int2 uone) <= 1%Z)%Z) -> let o20 :=
  (((offset xd1) + (to_int sy))%Z - 1%Z)%Z in let o21 := (offset xd1) in
  let o22 := (offset xp3) in let o23 := (pelts x4) in
