...
Theorem VC_div_sb_qr : forall (q:(ptr uint64)) (x:(ptr uint64)) (y:(ptr
  ...
  (((to_int zero) < (to_int i))%Z -> forall (o8:int32),
  ((to_int o8) = ((to_int i) - (to_int one))%Z) -> forall (i1:int32),
  (i1 = o8) -> let s := (((to_int sy) + (to_int i1))%Z - 1%Z)%Z in
  forall (o9:(ptr uint64)),
  ...
  ((offset xp2) + (to_int one))%Z)) = (to_int2 dl))) -> forall (o10:uint64),
  ((to_int2 o10) = 18446744073709551615%Z) -> forall (ql:uint64),
  (ql = o10) -> let o11 := ((offset xd1) + (to_int sy))%Z in let o12 :=
  (offset xd1) in let o13 := (offset x3) in let o14 := (pelts x3) in
  (((value_sub o14 o13 o11) = ((value_sub o14 o13 o12) + ((value_sub o14 o12
  o11) * (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o12 - o13)%Z))%Z)%Z) -> let o15 :=
  (((offset xd1) + (to_int sy))%Z - 1%Z)%Z in let o16 := (offset xd1) in
  let o17 := (pelts xd1) in (((value_sub o17 o16
  (o15 + 1%Z)%Z) = ((value_sub o17 o16 o15) + ((to_int2 (o17
  o15)) * (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o15 - o16)%Z))%Z)%Z) -> let vlx := (value_sub_shift xd1
  ((to_int sy) - 1%Z)%Z) in (((value_sub_shift xd1
  (to_int sy)) = (vlx + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  ((to_int sy) - 1%Z)%Z) * (to_int2 dl))%Z)%Z) -> let o18 :=
  (((offset y) + (to_int sy))%Z - 1%Z)%Z in let o19 := (offset y) in
  let o20 := (pelts y) in (((value_sub o20 o19
  (o18 + 1%Z)%Z) = ((value_sub o20 o19 o18) + ((to_int2 (o20
  o18)) * (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o18 - o19)%Z))%Z)%Z) -> let o21 :=
  (((offset y) + (to_int sy))%Z - 2%Z)%Z in let o22 := (offset y) in
  let o23 := (pelts y) in (((value_sub o23 o22
  (o21 + 1%Z)%Z) = ((value_sub o23 o22 o21) + ((to_int2 (o23
  o21)) * (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o21 - o22)%Z))%Z)%Z) -> let vly := (value_sub_shift y
  ((to_int sy) - 2%Z)%Z) in
  ((vy = ((vly + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  ((to_int sy) - 2%Z)%Z) * (to_int2 dl))%Z)%Z + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  ((to_int sy) - 1%Z)%Z) * (to_int2 dh))%Z)%Z) -> (((((value_sub (pelts xd1)
  ((offset xd1) + 1%Z)%Z
  (((offset xd1) + (to_int sy))%Z - 1%Z)%Z) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  ((to_int sy) - 2%Z)%Z) * (to_int2 dl))%Z)%Z + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  ((to_int sy) - 1%Z)%Z) * (to_int2 dh))%Z)%Z < vy)%Z -> let o24 :=
  (contents (data x3)) in forall (xc:(array uint64)),
  (((length xc) = (length o24)) /\ forall (i2:Z), ((0%Z <= i2)%Z /\
  (i2 < (length xc))%Z) -> ((mixfix_lbrb xc i2) = (mixfix_lbrb o24 i2))) ->
  let o25 := ((offset x3) + (to_int i1))%Z in let o26 := (offset x3) in
  (((value_sub (pelts x3) o26 o25) = (value_sub (elts xc) o26 o25)) ->
  forall (xp3:(ptr uint64)) (x4:(ptr uint64)), let xd2 := (mk_ptr (data x4)
  (offset xd1)) in
  ...
  forall (b:uint64), ((((value_sub_shift xd2
  (to_int sy)) - ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (to_int sy)) * (to_int2 b))%Z)%Z = ((value_sub_shift xd1
  (to_int sy)) - ((value_sub_shift y (to_int sy)) * (to_int2 ql))%Z)%Z) /\
  forall (j:Z), ((j < (offset xd1))%Z \/
  (((offset xd1) + (to_int sy))%Z <= j)%Z) -> (((pelts xd2) j) = ((pelts xd1)
  j))) -> (((value_sub_shift x4 (to_int i1)) = (value_sub_shift x3
  (to_int i1))) -> let o27 := ((offset xd1) + (to_int sy))%Z in let o28 :=
  (offset xd1) in (((value_sub (pelts xd2) o28
  o27) < (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o27 - o28)%Z))%Z -> ((0%Z <= (value_sub (pelts xd2) (offset xd1)
  ((offset xd1) + (to_int sy))%Z))%Z -> let o29 :=
  (((offset xd1) + (to_int sy))%Z - 1%Z)%Z in let o30 := (offset xd1) in
  let o31 := (pelts xd2) in (((value_sub o31 o30 o29) = ((to_int2 (o31
  o30)) + ((18446744073709551615%Z + 1%Z)%Z * (value_sub o31 (o30 + 1%Z)%Z
  o29))%Z)%Z) -> ((vlx < ((18446744073709551615%Z + 1%Z)%Z * vly)%Z)%Z ->
  ((b = dh) -> let o32 := ((offset x4) + s)%Z in let o33 := (offset xd1) in
  let o34 := (offset x4) in let o35 := (pelts x4) in (((value_sub o35 o34
  o32) = ((value_sub o35 o34 o33) + ((value_sub o35 o33
  o32) * (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o33 - o34)%Z))%Z)%Z) -> forall (x12:uint64),
  (x12 = (mixfix_lbrb (contents (data xp3))
  ((offset xp3) + (to_int one))%Z)) -> forall (o36:(ptr uint64)),
  (((offset o36) = ((offset qp) + (to_int minus_one))%Z) /\
  ((data o36) = (data qp))) -> forall (qp1:(ptr uint64)), (qp1 = o36) ->
  let o37 :=
  ((((offset qp1) + (to_int sx))%Z - (to_int sy))%Z - (to_int i1))%Z in
  let o38 := ((offset qp1) + 1%Z)%Z in let o39 := (pelts q1) in
  (((value_sub o39 o38 o37) = (value_sub (map.Map.set o39 (offset qp1) ql)
  o38 o37)) -> forall (qp2:(ptr uint64)) (q2:(ptr uint64)),
  ...
  (offset qp1) ql)) -> let o40 :=
  ((((offset qp2) + (to_int sx))%Z - (to_int sy))%Z - (to_int i1))%Z in
  let o41 := (offset qp2) in let o42 := (pelts q2) in (((value_sub o42 o41
  o40) = ((to_int2 (o42
  o41)) + ((18446744073709551615%Z + 1%Z)%Z * (value_sub o42 (o41 + 1%Z)%Z
  o40))%Z)%Z) -> let o43 :=
  ((((offset x4) + (to_int sy))%Z + (to_int i1))%Z - 1%Z)%Z in let o44 :=
  (offset x4) in let o45 := (pelts x4) in (((value_sub o45 o44
  (o43 + 1%Z)%Z) = ((value_sub o45 o44 o43) + ((to_int2 (o45
  o43)) * (int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (o43 - o44)%Z))%Z)%Z) -> ((((value_sub_shift xd2
  ((to_int sy) - 1%Z)%Z) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  ((to_int sy) - 1%Z)%Z) * (to_int2 x12))%Z)%Z = (((value_sub_shift xd1
  (to_int sy)) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (to_int sy)) * (to_int2 x11))%Z)%Z - ((to_int2 ql) * vy)%Z)%Z) ->
  ((((pelts xp3) = (pelts x4)) /\ ((pelts x4) = (pelts xd2))) ->
  ((((value_sub_shift xd2 (to_int sy)) = (((value_sub_shift xd1
  (to_int sy)) - ((to_int2 ql) * vy)%Z)%Z + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (to_int sy)) * (to_int2 b))%Z)%Z) /\ ((((value_sub_shift xd1
  (to_int sy)) - ((to_int2 ql) * vy)%Z)%Z + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (to_int sy)) * (to_int2 b))%Z)%Z = (((value_sub_shift xd1
  (to_int sy)) - ((to_int2 ql) * vy)%Z)%Z + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (to_int sy)) * (to_int2 dh))%Z)%Z)) -> (((value_sub_shift x4
  s) = ((value_sub_shift x4
  (to_int i1)) + ((int.Power.power (18446744073709551615%Z + 1%Z)%Z
  (to_int i1)) * (value_sub_shift xd2 ((to_int sy) - 1%Z)%Z))%Z)%Z) ->
  let m := ((to_int sy) - 1%Z)%Z in let x5 :=
  (18446744073709551615%Z + 1%Z)%Z in (((int.Power.power x5
  s) = (int.Power.power x5 ((to_int i1) + m)%Z)) ->
  (((0%Z <= (to_int i1))%Z /\ ((0%Z <= m)%Z /\ forall (x6:Z) (n:Z) (m1:Z),
  (0%Z <= n)%Z -> ((0%Z <= m1)%Z -> ((int.Power.power x6
  (n + m1)%Z) = ((int.Power.power x6 n) * (int.Power.power x6 m1))%Z)))) ->
  ((int.Power.power x5 ((to_int i1) + m)%Z) = ((int.Power.power x5
  (to_int i1)) * (int.Power.power x5
  m))%Z)))))))))))))))))))))))))))))))))))))) /\
