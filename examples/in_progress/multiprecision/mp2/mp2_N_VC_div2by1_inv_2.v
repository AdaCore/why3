...
(* Why3 goal *)
Theorem VC_div2by1_inv : forall (uh:uint64) (ul:uint64) (d:uint64)
  (v:uint64), (((int.EuclideanDivision.div (18446744073709551615%Z + 1%Z)%Z
  2%Z) <= (to_int2 d))%Z /\ (((to_int2 uh) < (to_int2 d))%Z /\ (reciprocal v
  d))) -> forall (zero:uint64), ((to_int2 zero) = 0%Z) ->
  forall (one:uint64), ((to_int2 one) = 1%Z) -> let k :=
  (((18446744073709551615%Z + 1%Z)%Z * (18446744073709551615%Z + 1%Z)%Z)%Z - (((18446744073709551615%Z + 1%Z)%Z + (to_int2 v))%Z * (to_int2 d))%Z)%Z in
  (((1%Z <= k)%Z /\ (k <= (to_int2 d))%Z) -> forall (o:uint64) (o1:uint64),
  (((to_int2 o) + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 o1))%Z)%Z = ((to_int2 v) * (to_int2 uh))%Z) ->
  forall (o2:uint64) (o3:uint64),
  ((((to_int2 o2) + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 o3))%Z)%Z = (((to_int2 o) + (to_int2 ul))%Z + (to_int2 zero))%Z) /\
  ...
  (((((to_int2 o2) + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 o4))%Z)%Z + (((18446744073709551615%Z + 1%Z)%Z * (18446744073709551615%Z + 1%Z)%Z)%Z * (to_int2 o5))%Z)%Z = ((((to_int2 o) + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 o1))%Z)%Z + (to_int2 ul))%Z + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 uh))%Z)%Z) ->
  (((to_int2 o5) = 0%Z) ->
  (((((to_int2 o2) + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 o4))%Z)%Z = ((((to_int2 o) + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 o1))%Z)%Z + (to_int2 ul))%Z + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 uh))%Z)%Z) /\
  ((((((to_int2 o) + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 o1))%Z)%Z + (to_int2 ul))%Z + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 uh))%Z)%Z = ((((to_int2 v) * (to_int2 uh))%Z + (to_int2 ul))%Z + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 uh))%Z)%Z) /\
  (((((to_int2 v) * (to_int2 uh))%Z + (to_int2 ul))%Z + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 uh))%Z)%Z = ((to_int2 ul) + (((18446744073709551615%Z + 1%Z)%Z + (to_int2 v))%Z * (to_int2 uh))%Z)%Z))) ->
  let q0 := (to_int2 o2) in let cq := ((to_int2 o4) + 1%Z)%Z in let cr :=
  (((to_int2 ul) - (cq * (to_int2 d))%Z)%Z + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 uh))%Z)%Z in
  ((((cq * (to_int2 d))%Z + cr)%Z = ((to_int2 ul) + ((18446744073709551615%Z + 1%Z)%Z * (to_int2 uh))%Z)%Z) ->
  forall (o6:uint64),
  ((to_int2 o6) = (int.EuclideanDivision.mod1 ((to_int2 o4) + (to_int2 one))%Z
  (18446744073709551615%Z + 1%Z)%Z)) -> forall (qh:uint64), (qh = o6) ->
  (((to_int2 qh) = (int.EuclideanDivision.mod1 cq
  (18446744073709551615%Z + 1%Z)%Z)) -> forall (p:uint64),
  ((to_int2 p) = (int.EuclideanDivision.mod1 ((to_int2 qh) * (to_int2 d))%Z
  (18446744073709551615%Z + 1%Z)%Z)) -> forall (o7:uint64),
  ((to_int2 o7) = (int.EuclideanDivision.mod1 ((to_int2 ul) - (to_int2 p))%Z
  (18446744073709551615%Z + 1%Z)%Z)) ->
  (((to_int2 o7) = (int.EuclideanDivision.mod1 cr
  (18446744073709551615%Z + 1%Z)%Z)) ->
  ((((18446744073709551615%Z + 1%Z)%Z * cr)%Z = (((((to_int2 uh) * k)%Z + ((to_int2 ul) * ((18446744073709551615%Z + 1%Z)%Z - (to_int2 d))%Z)%Z)%Z + (q0 * (to_int2 d))%Z)%Z - ((18446744073709551615%Z + 1%Z)%Z * (to_int2 d))%Z)%Z) ->
  let o8 := ((18446744073709551615%Z + 1%Z)%Z - (to_int2 d))%Z in
  (((o8 * (to_int2 ul))%Z < (o8 * (18446744073709551615%Z + 1%Z)%Z)%Z)%Z ->
  ((((18446744073709551615%Z + 1%Z)%Z * cr)%Z = (((((to_int2 uh) * k)%Z + ((to_int2 ul) * ((18446744073709551615%Z + 1%Z)%Z - (to_int2 d))%Z)%Z)%Z + (q0 * (to_int2 d))%Z)%Z - ((18446744073709551615%Z + 1%Z)%Z * (to_int2 d))%Z)%Z) ->
  ((0%Z <= (((to_int2 uh) * k)%Z + ((to_int2 ul) * ((18446744073709551615%Z + 1%Z)%Z - (to_int2 d))%Z)%Z)%Z)%Z ->
  ((((q0 * (to_int2 d))%Z - ((18446744073709551615%Z + 1%Z)%Z * (to_int2 d))%Z)%Z <= ((18446744073709551615%Z + 1%Z)%Z * cr)%Z)%Z ->
  ((((-(18446744073709551615%Z + 1%Z)%Z)%Z * (to_int2 d))%Z <= ((18446744073709551615%Z + 1%Z)%Z * cr)%Z)%Z ->
  (((-(to_int2 d))%Z <= cr)%Z ->
  (((((q0 * (to_int2 d))%Z - ((18446744073709551615%Z + 1%Z)%Z * (to_int2 d))%Z)%Z <= ((18446744073709551615%Z + 1%Z)%Z * cr)%Z)%Z /\
  (((q0 * (to_int2 d))%Z - ((18446744073709551615%Z + 1%Z)%Z * (to_int2 d))%Z)%Z = ((q0 - (18446744073709551615%Z + 1%Z)%Z)%Z * (to_int2 d))%Z)) ->
  (((to_int2 d) < (18446744073709551615%Z + 1%Z)%Z)%Z ->
  ((0%Z < ((18446744073709551615%Z + 1%Z)%Z - q0)%Z)%Z ->
  ((((to_int2 d) * ((18446744073709551615%Z + 1%Z)%Z - q0)%Z)%Z < ((18446744073709551615%Z + 1%Z)%Z * ((18446744073709551615%Z + 1%Z)%Z - q0)%Z)%Z)%Z ->
  ((((q0 - (18446744073709551615%Z + 1%Z)%Z)%Z * (18446744073709551615%Z + 1%Z)%Z)%Z < ((q0 - (18446744073709551615%Z + 1%Z)%Z)%Z * (to_int2 d))%Z)%Z ->
  ((((q0 - (18446744073709551615%Z + 1%Z)%Z)%Z * (18446744073709551615%Z + 1%Z)%Z)%Z < ((18446744073709551615%Z + 1%Z)%Z * cr)%Z)%Z ->
  (((q0 - (18446744073709551615%Z + 1%Z)%Z)%Z < cr)%Z ->
  ((((ZArith.BinInt.Z.max ((18446744073709551615%Z + 1%Z)%Z - (to_int2 d))%Z (q0 + 1%Z)%Z) - (18446744073709551615%Z + 1%Z)%Z)%Z <= cr)%Z ->
  (((0%Z < k)%Z /\ (k <= (to_int2 d))%Z) -> (((0%Z <= (to_int2 uh))%Z /\
  ((to_int2 uh) < (to_int2 d))%Z) ->
  ((k * (to_int2 uh))%Z < (k * (to_int2 d))%Z)%Z)))))))))))))))))))))))).
intros uh ul d v (h1,(h2,h3)) zero h4 one h5 k (h6,h7) o o1 h8 o2 o3
(h9,(h10,h11)) o4 o5 (h12,(h13,h14)) h15 h16 (h17,(h18,h19)) q0 cq cr h20 o6
h21 qh h22 h23 p h24 o7 h25 h26 h27 o8 h28 h29 h30 h31 h32 h33 (h34,h35) h36
