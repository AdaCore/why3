...
Theorem VC_div3by2_inv : forall (uh:uint32) (um:uint32) (ul:uint32)
  ...
  (((((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z * cr)%Z < ((((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z * m)%Z - (((4294967295%Z + 1%Z)%Z - (to_int3 dl))%Z * ((((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z - (d * (1%Z + (4294967295%Z + 1%Z)%Z)%Z)%Z)%Z)%Z)%Z)%Z ->
  ((~ (d <= ((4294967295%Z + 1%Z)%Z * ((4294967295%Z + 1%Z)%Z - 1%Z)%Z)%Z)%Z) ->
  (((((to_int3 dl) + ((4294967295%Z + 1%Z)%Z * (to_int3 dh))%Z)%Z = d) /\
  (((4294967295%Z + 1%Z)%Z * ((4294967295%Z + 1%Z)%Z - 1%Z)%Z)%Z < d)%Z) ->
  (((to_int3 dl) < (4294967295%Z + 1%Z)%Z)%Z ->
  ((((to_int3 dl) + ((4294967295%Z + 1%Z)%Z * (to_int3 dh))%Z)%Z < ((4294967295%Z + 1%Z)%Z * (1%Z + (to_int3 dh))%Z)%Z)%Z ->
  ((((4294967295%Z + 1%Z)%Z - 1%Z)%Z < (1%Z + (to_int3 dh))%Z)%Z ->
  ((((4294967295%Z + 1%Z)%Z - 2%Z)%Z < (to_int3 dh))%Z ->
  (((to_int3 dh) = ((4294967295%Z + 1%Z)%Z - 1%Z)%Z) ->
  (((to_int3 uh) = (to_int3 dh)) ->
  (((((4294967295%Z + 1%Z)%Z * ((4294967295%Z + 1%Z)%Z - 1%Z)%Z)%Z + 1%Z)%Z <= d)%Z ->
  (((((((4294967295%Z + 1%Z)%Z * ((4294967295%Z + 1%Z)%Z - 1%Z)%Z)%Z + 1%Z)%Z * ((4294967295%Z + 1%Z)%Z + 1%Z)%Z)%Z <= (d * ((4294967295%Z + 1%Z)%Z + 1%Z)%Z)%Z)%Z /\
  ((((((4294967295%Z + 1%Z)%Z * ((4294967295%Z + 1%Z)%Z - 1%Z)%Z)%Z + 1%Z)%Z * ((4294967295%Z + 1%Z)%Z + 1%Z)%Z)%Z = ((((4294967295%Z + 1%Z)%Z * (((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z - 1%Z)%Z)%Z + (4294967295%Z + 1%Z)%Z)%Z + 1%Z)%Z) /\
  ((((((4294967295%Z + 1%Z)%Z * (((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z - 1%Z)%Z)%Z + (4294967295%Z + 1%Z)%Z)%Z + 1%Z)%Z = ((((((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z - (4294967295%Z + 1%Z)%Z)%Z + (4294967295%Z + 1%Z)%Z)%Z + 1%Z)%Z) /\
  (((((((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z - (4294967295%Z + 1%Z)%Z)%Z + (4294967295%Z + 1%Z)%Z)%Z + 1%Z)%Z = ((((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z + 1%Z)%Z)))) ->
  (((d * (int.EuclideanDivision.div ((((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z - 1%Z)%Z
  d))%Z <= (d * ((4294967295%Z + 1%Z)%Z + 1%Z)%Z)%Z)%Z -> let a :=
  (int.EuclideanDivision.div ((((4294967295%Z + 1%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z * (4294967295%Z + 1%Z)%Z)%Z - 1%Z)%Z
  d) in (((a * d)%Z < (((4294967295%Z + 1%Z)%Z + 1%Z)%Z * d)%Z)%Z ->
  (a < ((4294967295%Z + 1%Z)%Z + 1%Z)%Z)%Z)))))))))))))))))))))))))))))))))).
(* Why3 intros uh um ul dh dl v (h1,(h2,h3)) d zero h4 one h5 o o1 h6 o2 o3
        ...
        h62 h63 h64 h65 h66 h67 h68 (h69,(h70,(h71,h72))) h73 a h74. *)
...
apply Zmult_gt_0_lt_reg_r in h74.
omega.
omega.
Qed.
