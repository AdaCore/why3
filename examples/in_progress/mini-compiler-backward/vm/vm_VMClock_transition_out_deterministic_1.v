...
(* Why3 goal *)
Theorem transition_out_deterministic : forall (p:((list instr)* (func
  clock_state bool))%type) (mc1:clock_state) (mc2:clock_state)
  (mc3:clock_state), ((transition_out p mc1 mc2) /\ (transition_out p mc1
  mc3)) -> (mc2 = mc3).
intros p mc1 mc2 mc3 (h1,h2).
destruct mc1;destruct mc2;destruct mc3;destruct p.
unfold transition_out in *.
destruct h1 as [h11 [h12 [h13 h14]]]. destruct h2 as [h21 [h22 [h23 h24]]].
assert (VMS z1 l0 m0 = VMS z3 l1 m1).
eapply transition_deterministic. split;eassumption.
