...
(* Why3 goal *)
Theorem Test55expr : (many_steps (map.Map.const (Vint 0%Z):(map.Map.map
  mident value)) (Cons (x, (Vint 42%Z)) (Nil :(list (ident* value)%type)))
  (Ebin (Evar x) Oplus (Evalue (Vint 13%Z)))
  (map.Map.const (Vint 0%Z):(map.Map.map mident value)) (Cons (x,
