...
Theorem wp_reduction : forall (sigma:(map mident value)) (sigma':(map mident
  ...
  | (Ederef m) => True
  | (Eassign m e) => True
  | (Eseq e e1) => (forall (s':expr), (one_step sigma pi e1 sigma' pi' s') ->
      forall (q:fmla), (eval_fmla sigma pi (wp e1 q)) -> (eval_fmla sigma'
      pi' (wp s' q))) -> ((forall (s':expr), (one_step sigma pi e sigma' pi'
