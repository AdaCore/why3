...
(* Why3 goal *)
Theorem Test42expr : (many_steps (const (Vint 0%Z):(map refident value))
  (Cons (0%Z, (Vint 42%Z)) (Nil :(list (Z* value)%type))) (Evar 0%Z)
  (const (Vint 0%Z):(map refident value)) (Cons (0%Z, (Vint 42%Z))
  (Nil :(list (Z* value)%type))) (Evalue (Vint 42%Z)) 1%Z).
replace 1 with (0+1) by omega.
eapply many_steps_trans.
apply one_step_var.
