...
(* Why3 goal *)
Theorem progress : forall (s:stmt), forall (x:mident) (x1:term),
  (s = (Sassign x x1)) -> forall (sigma:(map.Map.map mident value))
  (pi:(list (ident* value)%type)) (sigmat:(map.Map.map mident datatype))
...
(* Why3 intros s x x1 h1 sigma pi sigmat pit q h2 h3 h4 h5. *)
