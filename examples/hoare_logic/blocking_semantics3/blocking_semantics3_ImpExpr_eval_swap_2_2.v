...
Theorem eval_swap_2 : forall (f:fmla),
  ...
  | (Fnot f1) => True
  | (Fimplies f1 f2) => True
  | (Flet i t f1) => (forall (id1:ident) (id2:ident) (v1:value) (v2:value),
      (~ (id1 = id2)) -> forall (sigma:(map mident value)) (pi:(list (ident*
      value)%type)), (eval_fmla sigma (Cons (id1, v1) (Cons (id2, v2) pi))
      f1) <-> (eval_fmla sigma (Cons (id2, v2) (Cons (id1, v1) pi)) f1)) ->
      forall (id1:ident) (id2:ident) (v1:value) (v2:value),
      (~ (id1 = id2)) -> forall (sigma:(map mident value)) (pi:(list (ident*
      value)%type)), (eval_fmla sigma (Cons (id2, v2) (Cons (id1, v1) pi))
      f) -> (eval_fmla sigma (Cons (id1, v1) (Cons (id2, v2) pi)) f)
  | (Fforall i d f1) => True
  end.
destruct f; auto.
simpl.
intros.
pattern (eval_term sigma (Cons (id1, v1) (Cons (id2, v2) pi )) t);
   rewrite eval_swap_term_2; auto.

assert (h: (infix_plpl 
  (Cons (i, eval_term sigma (Cons (id2, v2) (Cons (id1, v1) pi)) t) 
  (Nil : list (ident*value)))
  (Cons (id1, v1) (Cons (id2, v2) pi))) = 
  (Cons (i, eval_term sigma (Cons (id2, v2) (Cons (id1, v1) pi)) t))
  (Cons (id1, v1) (Cons (id2, v2) pi))); auto.
