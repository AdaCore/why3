...
Theorem eval_swap_term_any : forall (t:term),
  ...
  | (Tvar i) =>
      match t with
      | (Tvalue v) => True
      | (Tvar i1) => forall (sigma:(map mident value)) (pi:(list (ident*
          value)%type)) (l:(list (ident* value)%type)) (id1:ident)
          (id2:ident) (v1:value) (v2:value), (~ (id1 = id2)) ->
          ((eval_term sigma (infix_plpl l (Cons (id1, v1) (Cons (id2, v2)
          pi))) t) = (eval_term sigma (infix_plpl l (Cons (id2, v2) (Cons (
          id1, v1) pi))) t))
      | (Tderef m) => True
      | (Tbin t1 o t2) => True
      end
