...
Axiom rev_append_sorted_incr : forall (s:(list t)) (t1:(list t)),
  (sorted (rev_append s t1)) <-> ((sorted1 s) /\ ((sorted t1) /\ (compat s
  t1))).

(* Why3 goal *)
Theorem rev_append_sorted_decr : forall (s:(list t)) (t1:(list t)),
  (sorted1 (rev_append s t1)) <-> ((sorted s) /\ ((sorted1 t1) /\ (compat t1
  s))).
intros s.
