...
Theorem WP_parameter_build : forall (s:(list Z)), (forall (result:tree)
  ...
  match result1 with
  | Nil => ((depths 0%Z result) = s)
  | _ => forall (t:tree), ~ ((depths 0%Z t) = s)
  end) -> ((forall (t:tree) (sqt:(list Z)), ~ ((infix_plpl (depths 0%Z t)
  sqt) = s)) -> forall (t:tree), ~ ((depths 0%Z t) = s)).
(* YOU MAY EDIT THE PROOF BELOW *)
intuition.
replace (depths 0 t) with (infix_plpl (depths 0 t) Nil) in H1.
apply (H0 _ _ H1).
apply Append_l_nil.
Qed.
(* DO NOT EDIT BELOW *)
