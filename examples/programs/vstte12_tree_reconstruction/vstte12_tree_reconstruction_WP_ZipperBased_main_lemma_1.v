...
Lemma key_lemma:
  forall d d1, (d < d1)%Z -> forall t t1 t2 s d2, 
...
(* d >= d1+1 -> contradiction *)
admit.

intros t0 t3 s d2.
rewrite <- Append_assoc.
assert (d+1 < d1 \/ d=d1-1)%Z by omega.
destruct H0.
intros eq.
(*
generalize (IHt1 t0 t3 _ _ eq); intuition.
z.
omega.
*)
Admitted.
