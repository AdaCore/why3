...
Theorem WP_parameter_pop : forall (a:Type), forall (b:Z), forall (rho:(list
  ...
  | (Cons _ s) => forall (rho4:(list a)), (rho4 = s) -> ((((0%Z < rho3)%Z \/
      ...
      (rho6 = (rho3 + 1%Z)%Z) -> ((rho6 = b) -> forall (rho7:Z),
      (rho7 = 0%Z) -> forall (i:Z), ((0%Z <= i)%Z /\
      (i < (len (mk_buffer rho7 rho5 (mk_array b rho1) rho4)))%Z) ->
      ((((first (mk_buffer rho7 rho5 (mk_array b rho1)
      rho4)) + i)%Z < (size (mk_buffer rho7 rho5 (mk_array b rho1)
      rho4)))%Z -> ((nth i (sequence (mk_buffer rho7 rho5 (mk_array b rho1)
      rho4))) = (Some (get1 (data (mk_buffer rho7 rho5 (mk_array b rho1)
      rho4)) ((first (mk_buffer rho7 rho5 (mk_array b rho1)
      rho4)) + i)%Z))))))
  end.
