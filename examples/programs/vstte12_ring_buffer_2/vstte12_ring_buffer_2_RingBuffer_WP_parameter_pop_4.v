...
Theorem WP_parameter_pop : forall (a:Type), forall (b:Z), forall (rho:(list
  ...
  | (Cons _ s) => forall (rho4:(list a)), (rho4 = s) -> ((((0%Z < rho3)%Z \/
      ...
      rho4)))%Z) -> ((0%Z <= (((first (mk_buffer rho6 rho5 (mk_array b rho1)
      rho4)) + i)%Z - (size (mk_buffer rho6 rho5 (mk_array b rho1)
      rho4)))%Z)%Z -> ((nth i (sequence (mk_buffer rho6 rho5 (mk_array b
      rho1) rho4))) = (Some (get1 (data (mk_buffer rho6 rho5 (mk_array b
      rho1) rho4)) (((first (mk_buffer rho6 rho5 (mk_array b rho1)
      rho4)) + i)%Z - (size (mk_buffer rho6 rho5 (mk_array b rho1)
      rho4)))%Z))))))
  end.
