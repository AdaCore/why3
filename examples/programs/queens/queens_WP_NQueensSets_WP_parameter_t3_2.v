...
apply h1; intuition.
destruct (diff_def1 (diff (diff a b) c) e (get t k)) as (_, h); apply h; clear h; split.
destruct (diff_def1 (diff a b) c (get t k)) as (_, h); apply h; clear h; split.
destruct (diff_def1 a b (get t k)) as (_, h); apply h; clear h; split.
(* mem .. a *)
