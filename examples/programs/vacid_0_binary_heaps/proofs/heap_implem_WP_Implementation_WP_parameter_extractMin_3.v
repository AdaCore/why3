...
Axiom Is_heap_min : forall (a:(map.Map.map Z Z)) (n:Z), (0%Z < n)%Z ->
...
rewrite occ_add_eq with (y := Map.get a (n - 1)); auto.
assert (0 <= nb_occ (Map.get a (n - 1)) (elements a (0 + 1) (n - 1))); auto with zarith.
