...
Axiom Occ_elements : forall (a:Type), forall (a1:(map Z a)) (i:Z) (j:Z)
  (n:Z), ((i <= j)%Z /\ (j <  n)%Z) -> (0%Z <  (get (elements a1 i n) (get a1
  j)))%Z.
...
Theorem WP_parameter_extractMin : forall (this:(map Z Z)) (this1:Z),
  ...
  (0%Z <  (get (diff (elements this 0%Z this1) (set (empty_bag:(map Z Z))
  (get this 0%Z) 1%Z)) (get this (this1 - 1%Z)%Z)))%Z)).
...
assert (0 <= get (elements a (0 + 1) (n - 1)) (get a (n - 1))); auto with zarith.
