...
Theorem WP_parameter_extractMin : forall (this:(map Z Z)) (this1:Z),
  ((~ ((elements this 0%Z this1) = (empty_bag:(map Z Z)))) /\ (is_heap (this,
  this1))) -> ((0%Z <  this1)%Z -> forall (i:Z), forall (arr:(map Z Z)),
  ((0%Z <= i)%Z /\ ((is_heap_array arr 0%Z (this1 - 1%Z)%Z) /\ (((i = 0%Z) ->
  ((this = arr) /\ ((elements this 0%Z this1) = (add (get this
  (this1 - 1%Z)%Z) (elements this 0%Z (this1 - 1%Z)%Z))))) /\
  ((((0%Z <  i)%Z /\ (i <  (this1 - 1%Z)%Z)%Z) -> ((add (get arr i)
  (elements this 0%Z this1)) = (add (get this (this1 - 1%Z)%Z) (add (get this
  0%Z) (elements arr 0%Z (this1 - 1%Z)%Z))))) /\ ((0%Z <  i)%Z -> ((get arr
  (parent i)) <  (get this (this1 - 1%Z)%Z))%Z))))) ->
  ((i <  (this1 - 1%Z)%Z)%Z ->
  ((~ ((this1 - 1%Z)%Z <= ((2%Z * i)%Z + 1%Z)%Z)%Z) ->
  ((((2%Z * i)%Z + 2%Z)%Z <  (this1 - 1%Z)%Z)%Z -> ((~ ((get arr
  ((2%Z * i)%Z + 2%Z)%Z) <  (get arr ((2%Z * i)%Z + 1%Z)%Z))%Z) ->
  (((get this (this1 - 1%Z)%Z) <= (get arr ((2%Z * i)%Z + 1%Z)%Z))%Z ->
  (((add (get arr i) (elements this 0%Z this1)) = (add (get this
  (this1 - 1%Z)%Z) (add (get this 0%Z) (elements arr 0%Z
  (this1 - 1%Z)%Z)))) -> ((i <  (this1 - 1%Z)%Z)%Z -> forall (arr1:(map Z
  Z)), (arr1 = (set arr i (get this (this1 - 1%Z)%Z))) -> ((0%Z <  i)%Z ->
  (is_heap_array arr1 0%Z (this1 - 1%Z)%Z)))))))))).
(* YOU MAY EDIT THE PROOF BELOW *)
intuition; subst.
apply Is_heap_when_node_modified; unfold right; auto with zarith.
Qed.
(* DO NOT EDIT BELOW *)
