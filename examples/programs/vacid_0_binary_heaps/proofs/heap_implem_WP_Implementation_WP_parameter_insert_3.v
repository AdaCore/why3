...
Theorem WP_parameter_insert : forall (e:Z), forall (this:(map Z Z))
  ...
  (i <  this1)%Z) -> (is_heap (this2, this3))) -> ((elements this2 0%Z
  this3) = (add e (elements this 0%Z this1)))))).
(* YOU MAY EDIT THE PROOF BELOW *)
intros e a n _.
intros i a0 (Hi, (H1, H2)).
intros Hi_pos He a1 Ha1.
intros a2 n2 H.
inversion H; clear H; subst a2 n2.
intros _.
assert (h: (i<n \/ i=n)) by omega.
destruct h.
(* i < n *)
subst a1; apply Elements_set_inside; auto with zarith.
elim (H2 H); intros _ (_,H4); auto.
(* i = n *)
elim (H1 H); intros.
subst i a1.
rewrite <- Elements_union3; auto with zarith.
apply f_equal; auto.
Qed.
(* DO NOT EDIT BELOW *)
