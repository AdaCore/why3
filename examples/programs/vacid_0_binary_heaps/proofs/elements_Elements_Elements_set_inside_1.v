...
Axiom Occ_elements : forall {a:Type} {a_WT:WhyType a}, forall (a1:(map
...
Axiom Elements_set_outside : forall {a:Type} {a_WT:WhyType a},
  forall (a1:(map BuiltIn.int a)) (i:BuiltIn.int) (j:BuiltIn.int),
  (i <= j)%Z -> forall (k:BuiltIn.int), ((k < i)%Z \/ (j <= k)%Z) ->
...
Theorem Elements_set_inside : forall {a:Type} {a_WT:WhyType a},
  forall (a1:(map BuiltIn.int a)) (i:BuiltIn.int) (j:BuiltIn.int)
  (n:BuiltIn.int) (e:a) (b:(bag a)), ((i <= j)%Z /\ (j < n)%Z) ->
...
rewrite Union_assoc.
pattern (union (singleton (get a j)) (elements a i j)); rewrite Union_comm.
rewrite <- Union_assoc.
rewrite <- Union_assoc.
apply f_equal.
unfold add.
