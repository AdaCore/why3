...
Axiom const_value0 : ((double_of_bv64 (concat (from_int 1127219200%Z)
  (from_int 2147483648%Z))) = ((pow21 (1075%Z - 1023%Z)%Z) * (1%R + (2147483648%R * (pow21 (-52%Z)%Z))%R)%R)%R).

(* YOU MAY EDIT THE CONTEXT BELOW *)

(* DO NOT EDIT BELOW *)

Theorem const_value : ((double_of_bv64 (concat (from_int 1127219200%Z)
  (from_int 2147483648%Z))) = ((pow21 52%Z) + (pow21 31%Z))%R).
(* YOU MAY EDIT THE PROOF BELOW *)
rewrite const_value0.
rewrite Rmult_plus_distr_l.
rewrite Pow2_int_real.
rewrite <- pow31_real2.
rewrite pow31_real.
rewrite pow_mult.
rewrite pow_mult.
