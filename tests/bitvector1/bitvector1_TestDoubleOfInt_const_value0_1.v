...
Axiom to_nat_sub_one1 : forall (b:bv1) (j:Z) (i:Z), ((0%Z <= i)%Z /\
  ...
  i) = ((pow_of2 (j - i)%Z) + (to_nat_sub1 b (j - 1%Z)%Z i))%Z)).
...
Axiom to_nat_of_zero1 : forall (b:bv1) (i:Z) (j:Z), (forall (k:Z),
  ((k <= j)%Z /\ (i <= k)%Z) -> ((nth1 b k) = false)) -> ((to_nat_sub1 b j
  i) = 0%Z).
...
Axiom double_of_bv64_value : forall (b:bv1), ((0%Z <  (to_nat_sub1 b 62%Z
  ...
  ((double_of_bv64 b) = (((sign_value (nth1 b 63%Z)) * (pow 2%R
  (IZR ((to_nat_sub1 b 62%Z
  52%Z) - 1023%Z)%Z)))%R * (1%R + ((IZR (to_nat_sub1 b 51%Z 0%Z)) * (pow 2%R
  (-52%R)%R))%R)%R)%R).
...
Axiom mantissa_const : ((to_nat_sub1 (concat (from_int 1127219200%Z)
  (from_int 2147483648%Z)) 51%Z 0%Z) = (pow_of2 31%Z)).

Axiom pow31_real : ((IZR (pow_of2 31%Z)) = (pow 2%R 31%R)).

Axiom pow31_real2 : ((IZR (pow_of2 31%Z)) = 2147483648%R).

Parameter one: R.


Parameter infix_as: R -> R -> R.


Parameter power: R -> Z -> R.


Axiom Power_0 : forall (x:R), ((power x 0%Z) = one).

Axiom Power_s : forall (x:R) (n:Z), (0%Z <= n)%Z -> ((power x
  (n + 1%Z)%Z) = (infix_as x (power x n))).

Axiom Power_1 : forall (x:R), ((power x 1%Z) = x).
...
Theorem const_value0 : ((double_of_bv64 (concat (from_int 1127219200%Z)
  (from_int 2147483648%Z))) = ((pow 2%R
  (1075%R - 1023%R)%R) * (1%R + (2147483648%R * (pow 2%R
  (-52%R)%R))%R)%R)%R).
