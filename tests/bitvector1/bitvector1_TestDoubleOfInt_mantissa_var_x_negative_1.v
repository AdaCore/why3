...
Axiom nth_var2 : forall (x:Z), ((nth1 (var x) 31%Z) = (negb (nth (from_int x)
  31%Z))).
...
Axiom nat_to_sub_x : forall (x:Z), ((to_nat_sub1 (var x) 30%Z
  0%Z) = (to_nat_sub (from_int x) 30%Z 0%Z)).

Axiom x_positive : forall (x:Z), ((nth (from_int x) 31%Z) = false) ->
  ((to_nat_sub (from_int x) 31%Z 0%Z) = (to_nat_sub (from_int x) 30%Z 0%Z)).

Axiom x_positive1 : forall (x:Z), ((nth (from_int x) 31%Z) = false) ->
  ((to_nat_sub (from_int x) 30%Z 0%Z) = x).
