...
Definition no_overflow (m:floating_point.Rounding.mode) (x:R): Prop :=
  ((Reals.Rbasic_fun.Rabs (round m x)) <= %R)%R.

(* TODO Use Flocq theory to prove this fast. *)
Lemma eq_max_int: max 53 1024 = %R.
Proof.
unfold max. simpl. unfold Fcore_defs.F2R. simpl.
ring.
Qed.
...
forall (m:floating_point.Rounding.mode) (x:R),
 ((Reals.Rbasic_fun.Rabs x) <= %R)%R ->
 (no_overflow m x).
unfold no_overflow. rewrite <- eq_max_int.
...
forall (x:floating_point.DoubleFormat.double),
 ((Reals.Rbasic_fun.Rabs (value x)) <= %R)%R.
rewrite <- eq_max_int.
