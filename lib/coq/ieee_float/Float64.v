...
(* Why3 goal *)
Lemma is_not_nan1 :
forall (x:t), (is_not_nan x) <-> ~ (is_nan x).
Proof.
  apply is_not_nan1.
Qed.
...
Lemma max_real_cst :
  max_real 11 53 = (9007199254740991 * )%R.
Proof.
  change (9007199254740991 * )%R
    with (F2R (Float radix2 9007199254740991 971)).
...
(* Why3 goal *)
Lemma is_finite :
forall (x:t), (t'isFinite x) -> (in_range (t'real x)).
Proof.
...
Proof.
  ...
  rewrite <- max_real_cst.
  now apply (Bounded_real_no_overflow 11 53).
Qed.
...
forall (x:R),
 ((round ieee_float.RoundingMode.RTN (-x)%R) = (-(round ieee_float.RoundingMode.RTP
                                                   x))%R).
Proof.
...
Lemma Round_up_neg :
forall (x:R),
 ((round ieee_float.RoundingMode.RTP (-x)%R) = (-(round ieee_float.RoundingMode.RTN
                                                   x))%R).
Proof.
  apply Round_up_neg.
Qed.
...
(* Why3 goal *)
Lemma eq_refl :
forall (x:t), (t'isFinite x) -> (eq x x).
Proof.
  apply eq_refl.
Qed.
...
(* Why3 goal *)
Lemma le_ge_asym :
forall (x:t) (y:t), ((le x y) /\ (le y x)) -> (eq x y).
Proof.
  apply le_ge_asym.
Qed.
...
forall (m:ieee_float.RoundingMode.mode) (x:t) (y:t),
 (ieee_float.RoundingMode.to_nearest m) ->
 ((t'isFinite (add m x y)) ->
  ((no_overflow m ((t'real x) + (t'real y))%R)
   /\ ((t'real (add m x y)) = (round m ((t'real x) + (t'real y))%R)))).
Proof.
...
forall (m:ieee_float.RoundingMode.mode) (x:t) (y:t),
 ...
 ((((is_nan x) \/ (is_nan y)) -> (is_nan r))
  /\ ((((is_zero x) /\ (is_infinite y)) -> (is_nan r))
      /\ ((((t'isFinite x) /\ ((is_infinite y) /\ ~ (is_zero x))) ->
           (is_infinite r))
          /\ ((((is_infinite x) /\ (is_zero y)) -> (is_nan r))
              /\ ((((is_infinite x) /\ ((t'isFinite y) /\ ~ (is_zero y))) ->
                   (is_infinite r))
                  /\ ((((is_infinite x) /\ (is_infinite y)) -> (is_infinite
                       r))
                      /\ ((((t'isFinite x)
                            /\ ((t'isFinite y)
                                /\ ~ (no_overflow m
              ...
              /\ ((((t'isFinite x)
                    /\ ((t'isFinite y)
                        /\ ((~ (is_zero y))
                            /\ ~ (no_overflow m ((t'real x) / (t'real y))%R)))) ->
                   (overflow_value m r))
                  /\ ((((t'isFinite x) /\ ((is_zero y) /\ ~ (is_zero x))) ->
                       (is_infinite r))
  ...
  /\ ((((is_zero x) /\ (is_infinite y)) -> (is_nan r))
      /\ ((((is_infinite x) /\ (is_zero y)) -> (is_nan r))
          /\ ((((t'isFinite x)
              ...
              /\ ((((t'isFinite x)
                    /\ ((~ (is_zero x))
                        /\ ((is_infinite y) /\ (is_infinite z)))) ->
                   (((product_sign z x y) ->
                     ((is_infinite r) /\ (same_sign r z)))
                    /\ ((~ (product_sign z x y)) -> (is_nan r))))
                  /\ ((((is_infinite x)
                        /\ ((t'isFinite y)
                            /\ ((~ (is_zero y)) /\ (t'isFinite z)))) ->
                       ((is_infinite r) /\ (product_sign r x y)))
                      /\ ((((is_infinite x)
                            /\ ((t'isFinite y)
                                /\ ((~ (is_zero y)) /\ (is_infinite z)))) ->
                           (((product_sign z x y) ->
                             ((is_infinite r) /\ (same_sign r z)))
                            /\ ((~ (product_sign z x y)) -> (is_nan r))))
                          /\ ((((is_infinite x)
                               ...
                               ((is_infinite r) /\ (product_sign r x y)))
                              /\ ((((t'isFinite x)
                                    /\ ((t'isFinite y) /\ (is_infinite z))) ->
                                   ((is_infinite r) /\ (same_sign r z)))
                                  /\ ((((is_infinite x)
                                        /\ ((is_infinite y) /\ (is_infinite
                                            z))) ->
                                       (((product_sign z x y) ->
                                         ((is_infinite r) /\ (same_sign r z)))
                                        /\ ((~ (product_sign z x y)) ->
...
forall (m:ieee_float.RoundingMode.mode) (n:ieee_float.RoundingMode.mode)
 ...
 (in_safe_int_range i) ->
 ((in_safe_int_range j) ->
  ((in_safe_int_range (i + j)%Z) -> (eq (of_int m (i + j)%Z)
...
(* Why3 goal *)
Lemma Min_r :
forall (x:t) (y:t), (le y x) -> (eq (min x y) y).
Proof.
  apply Min_r.
Qed.
...
(* Why3 goal *)
Lemma Min_l :
forall (x:t) (y:t), (le x y) -> (eq (min x y) x).
Proof.
  apply Min_l.
Qed.
...
(* Why3 goal *)
Lemma Max_r :
forall (x:t) (y:t), (le y x) -> (eq (max x y) x).
Proof.
  apply Max_r.
Qed.
...
(* Why3 goal *)
Lemma Max_l :
forall (x:t) (y:t), (le x y) -> (eq (max x y) y).
Proof.
  apply Max_l.
Qed.
...
(* Why3 goal *)
Lemma eq_is_int :
forall (x:t) (y:t), (eq x y) -> ((is_int x) -> (is_int y)).
Proof.
  apply eq_is_int.
Qed.
...
(* Why3 goal *)
Lemma fma_int :
forall (x:t) (y:t) (z:t) (m:ieee_float.RoundingMode.mode),
 (is_int x) ->
 ((is_int y) ->
...
(* Why3 goal *)
Lemma neg_int :
forall (x:t), (is_int x) -> (is_int (neg x)).
Proof.
  apply neg_int.
Qed.
...
(* Why3 goal *)
Lemma abs_int :
forall (x:t), (is_int x) -> (is_int (abs x)).
Proof.
  apply abs_int.
Qed.
...
(* Why3 goal *)
Lemma is_int_is_finite :
forall (x:t), (is_int x) -> (t'isFinite x).
Proof.
...
forall (x:t),
 (t'isFinite x) ->
 ((is_negative x) ->
  ((roundToIntegral ieee_float.RoundingMode.RTZ x) = (roundToIntegral ieee_float.RoundingMode.RTP
                                                       x))).
Proof.
  apply truncate_neg.
Qed.
...
forall (x:t),
 (t'isFinite x) ->
 ((is_positive x) ->
  ((roundToIntegral ieee_float.RoundingMode.RTZ x) = (roundToIntegral ieee_float.RoundingMode.RTN
                                                       x))).
Proof.
  apply truncate_pos.
Qed.
...
forall (x:t),
 (t'isFinite x) ->
 ((t'real (roundToIntegral ieee_float.RoundingMode.RTP x)) = (BuiltIn.IZR 
...
forall (m:ieee_float.RoundingMode.mode) (x:t),
 (t'isFinite x) ->
 ((to_int m (roundToIntegral ieee_float.RoundingMode.RTP x)) = (real.Truncate.ceil 
                                                                 (t'real x))).
Proof.
...
Lemma floor_le :
forall (x:t),
 (t'isFinite x) -> (le (roundToIntegral ieee_float.RoundingMode.RTN x) x).
Proof.
  now apply floor_le.
Qed.
...
forall (x:t),
 (t'isFinite x) ->
 ((t'real (roundToIntegral ieee_float.RoundingMode.RTN x)) = (BuiltIn.IZR 
...
forall (m:ieee_float.RoundingMode.mode) (x:t),
 (t'isFinite x) ->
 ((to_int m (roundToIntegral ieee_float.RoundingMode.RTN x)) = (real.Truncate.floor 
                                                                 (t'real x))).
Proof.
...
forall (x:t),
 ...
 ((roundToIntegral ieee_float.RoundingMode.RNA x) = (roundToIntegral ieee_float.RoundingMode.RTN
                                                      x)).
Proof.
  apply RNA_down.
Qed.
...
forall (x:t),
 ...
 (sub ieee_float.RoundingMode.RNE x
   (roundToIntegral ieee_float.RoundingMode.RTN x))) ->
 ((roundToIntegral ieee_float.RoundingMode.RNA x) = (roundToIntegral ieee_float.RoundingMode.RTP
                                                      x)).
Proof.
  apply RNA_up.
Qed.
